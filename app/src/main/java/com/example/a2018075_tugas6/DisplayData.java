...
import static com.example.a2018075_tugas6.DBmain.TABLENAME;
...
import com.example.a2018075_tugas6.databinding.DisplayDataBinding;
...
public class DisplayData extends AppCompatActivity {
    ...
    MyAdapter myAdapter;
    private DisplayDataBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding =
                DisplayDataBinding.inflate(getLayoutInflater());
